...
<div class="col-md-9 col-lg-9 col-sm-9 pull-left">
        ...
        <div class= "jumbotron">
                ...
                <table>
                    ...
                    <tr>
                        <td><li class="list-unstyled"><a href="/VPM/{{$user->id}}"><pre>{{$user->first_name}} {{$user->last_name}}</pre></a> </li></td>
                        <td><li class="list-unstyled"><a href="#">{{$user->email}}</a></li></td>
                        <td> <form id ="add_user" action = "{{route('VPM.adduser')}}" method="POST" >
...
<div class="col-sm-3 col-md-3 col-lg-3 pull-right">
    ...
    <div class="sidebar-module">
            ...
            <hr/>
            <h4>Add Vise Project Manager</h4>
            <div class="row">
